...
function $f_Lquizleague_web_core_Module__apply__sjs_js_Array($thiz) {
  var array = $thiz.components__sjs_js_Array();
  var i = 0;
  var len = $uI(array.length);
  while ((i < len)) {
    var index = i;
    var arg1 = array[index];
    var x$1 = $as_Lquizleague_web_core_PageComponent(arg1);
    x$1.apply__sjs_js_Any();
    i = ((1 + i) | 0)
  };
  var array$1 = $thiz.modules__sjs_js_Array();
  var array$2 = [];
  var i$1 = 0;
  ...
  while ((i$1 < len$1)) {
    ...
    var x$2 = $as_Lquizleague_web_core_Module(arg1$1);
    var array$3 = $f_Lquizleague_web_core_Module__apply__sjs_js_Array(x$2);
    var i$2 = 0;
  ...
  var that = $thiz.routes__sjs_js_Array();
  return $m_sjs_js_ArrayOps$().scala$scalajs$js$ArrayOps$$concat__sjs_js_Array__sjs_js_Array__sjs_js_Array(array$2, that)
}
function $f_Lquizleague_web_core_Module__components__sjs_js_Array($thiz) {
  return []
}
function $f_Lquizleague_web_core_Module__modules__sjs_js_Array($thiz) {
  return []
}
function $is_Lquizleague_web_core_Module(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lquizleague_web_core_Module)))
}
function $as_Lquizleague_web_core_Module(obj) {
  return (($is_Lquizleague_web_core_Module(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "quizleague.web.core.Module"))
}
function $isArrayOf_Lquizleague_web_core_Module(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lquizleague_web_core_Module)))
}
function $asArrayOf_Lquizleague_web_core_Module(obj, depth) {
  return (($isArrayOf_Lquizleague_web_core_Module(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lquizleague.web.core.Module;", depth))
}
function $is_Lquizleague_web_core_PageComponent(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lquizleague_web_core_PageComponent)))
}
function $as_Lquizleague_web_core_PageComponent(obj) {
  return (($is_Lquizleague_web_core_PageComponent(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "quizleague.web.core.PageComponent"))
}
function $isArrayOf_Lquizleague_web_core_PageComponent(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lquizleague_web_core_PageComponent)))
}
function $asArrayOf_Lquizleague_web_core_PageComponent(obj, depth) {
  return (($isArrayOf_Lquizleague_web_core_PageComponent(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lquizleague.web.core.PageComponent;", depth))
}
/** @constructor */
function $c_O() {
  /*<skip>*/
...
/** @constructor */
function $c_Lcom_felstar_scalajs_vue_Component$() {
  $c_O.call(this)
}
$c_Lcom_felstar_scalajs_vue_Component$.prototype = new $h_O();
$c_Lcom_felstar_scalajs_vue_Component$.prototype.constructor = $c_Lcom_felstar_scalajs_vue_Component$;
/** @constructor */
function $h_Lcom_felstar_scalajs_vue_Component$() {
  /*<skip>*/
}
$h_Lcom_felstar_scalajs_vue_Component$.prototype = $c_Lcom_felstar_scalajs_vue_Component$.prototype;
$c_Lcom_felstar_scalajs_vue_Component$.prototype.init___ = (function() {
  return this
});
$c_Lcom_felstar_scalajs_vue_Component$.prototype.$$js$exported$meth$apply__T__sjs_js_Any__sjs_js_Any__O = (function(template, data, subscriptions) {
  return this.apply__T__sjs_js_Any__sjs_js_Any__sjs_js_Object(template, data, subscriptions)
});
$c_Lcom_felstar_scalajs_vue_Component$.prototype.$$js$exported$meth$apply$default$3__sjs_js_Any = (function() {
  return null
});
$c_Lcom_felstar_scalajs_vue_Component$.prototype.$$js$exported$meth$apply$default$2__sjs_js_Any = (function() {
  return null
});
$c_Lcom_felstar_scalajs_vue_Component$.prototype.apply__T__sjs_js_Any__sjs_js_Any__sjs_js_Object = (function(template, data, subscriptions) {
  return {
    "template": template,
    "data": data,
...
$c_Lcom_felstar_scalajs_vue_Component$.prototype.apply = (function(arg$1) {
  ...
  var prep1 = ((arg$rest[0] === (void 0)) ? this.$$js$exported$meth$apply$default$2__sjs_js_Any() : arg$rest[0]);
  var prep2 = ((arg$rest[1] === (void 0)) ? this.$$js$exported$meth$apply$default$3__sjs_js_Any() : arg$rest[1]);
  return this.$$js$exported$meth$apply__T__sjs_js_Any__sjs_js_Any__O(prep0, prep1, prep2)
});
var $d_Lcom_felstar_scalajs_vue_Component$ = new $TypeData().initClass({
  Lcom_felstar_scalajs_vue_Component$: 0
}, false, "com.felstar.scalajs.vue.Component$", {
  Lcom_felstar_scalajs_vue_Component$: 1,
  O: 1
});
$c_Lcom_felstar_scalajs_vue_Component$.prototype.$classData = $d_Lcom_felstar_scalajs_vue_Component$;
var $n_Lcom_felstar_scalajs_vue_Component$ = (void 0);
function $m_Lcom_felstar_scalajs_vue_Component$() {
  if ((!$n_Lcom_felstar_scalajs_vue_Component$)) {
    $n_Lcom_felstar_scalajs_vue_Component$ = new $c_Lcom_felstar_scalajs_vue_Component$().init___()
  };
  return $n_Lcom_felstar_scalajs_vue_Component$
}
/** @constructor */
function $c_Lcom_felstar_scalajs_vue_RouteConfig$() {
  $c_O.call(this)
}
$c_Lcom_felstar_scalajs_vue_RouteConfig$.prototype = new $h_O();
$c_Lcom_felstar_scalajs_vue_RouteConfig$.prototype.constructor = $c_Lcom_felstar_scalajs_vue_RouteConfig$;
/** @constructor */
function $h_Lcom_felstar_scalajs_vue_RouteConfig$() {
  /*<skip>*/
}
$h_Lcom_felstar_scalajs_vue_RouteConfig$.prototype = $c_Lcom_felstar_scalajs_vue_RouteConfig$.prototype;
$c_Lcom_felstar_scalajs_vue_RouteConfig$.prototype.init___ = (function() {
  return this
});
$c_Lcom_felstar_scalajs_vue_RouteConfig$.prototype.apply__T__sjs_js_Any__T__sci_Map__sjs_js_Any__sjs_js_Any__sjs_js_Any__sjs_js_Array__sjs_js_Object = (function(path, component, name, components, redirect, props, alias, children) {
  if ((components === null)) {
    var jsx$1 = null
  } else {
    var this$4 = $m_sjs_js_JSConverters$JSRichGenMap$();
    var result = {};
    components.foreach__F1__V(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this, result$1) {
...
$c_Lcom_felstar_scalajs_vue_RouteConfig$.prototype.apply$default$8__sjs_js_Array = (function() {
  return []
});
var $d_Lcom_felstar_scalajs_vue_RouteConfig$ = new $TypeData().initClass({
  Lcom_felstar_scalajs_vue_RouteConfig$: 0
}, false, "com.felstar.scalajs.vue.RouteConfig$", {
  Lcom_felstar_scalajs_vue_RouteConfig$: 1,
  O: 1
});
$c_Lcom_felstar_scalajs_vue_RouteConfig$.prototype.$classData = $d_Lcom_felstar_scalajs_vue_RouteConfig$;
var $n_Lcom_felstar_scalajs_vue_RouteConfig$ = (void 0);
function $m_Lcom_felstar_scalajs_vue_RouteConfig$() {
  if ((!$n_Lcom_felstar_scalajs_vue_RouteConfig$)) {
    $n_Lcom_felstar_scalajs_vue_RouteConfig$ = new $c_Lcom_felstar_scalajs_vue_RouteConfig$().init___()
  };
  return $n_Lcom_felstar_scalajs_vue_RouteConfig$
}
/** @constructor */
function $c_Lcom_felstar_scalajs_vue_Router$() {
  $c_O.call(this)
}
$c_Lcom_felstar_scalajs_vue_Router$.prototype = new $h_O();
$c_Lcom_felstar_scalajs_vue_Router$.prototype.constructor = $c_Lcom_felstar_scalajs_vue_Router$;
/** @constructor */
function $h_Lcom_felstar_scalajs_vue_Router$() {
  /*<skip>*/
}
$h_Lcom_felstar_scalajs_vue_Router$.prototype = $c_Lcom_felstar_scalajs_vue_Router$.prototype;
$c_Lcom_felstar_scalajs_vue_Router$.prototype.init___ = (function() {
  return this
});
$c_Lcom_felstar_scalajs_vue_Router$.prototype.apply__sjs_js_Array__T__T__T__T__Lcom_felstar_scalajs_vue_Router = (function(routes, mode, base, linkActiveClass, linkExactActiveClass) {
  return new $g.VueRouter({
    "routes": routes,
    "mode": mode,
    "base": base,
...
var $d_Lcom_felstar_scalajs_vue_Router$ = new $TypeData().initClass({
  Lcom_felstar_scalajs_vue_Router$: 0
}, false, "com.felstar.scalajs.vue.Router$", {
  Lcom_felstar_scalajs_vue_Router$: 1,
  O: 1
});
$c_Lcom_felstar_scalajs_vue_Router$.prototype.$classData = $d_Lcom_felstar_scalajs_vue_Router$;
var $n_Lcom_felstar_scalajs_vue_Router$ = (void 0);
function $m_Lcom_felstar_scalajs_vue_Router$() {
  if ((!$n_Lcom_felstar_scalajs_vue_Router$)) {
    $n_Lcom_felstar_scalajs_vue_Router$ = new $c_Lcom_felstar_scalajs_vue_Router$().init___()
  };
  return $n_Lcom_felstar_scalajs_vue_Router$
}
/** @constructor */
function $c_Lquizleague_web_site_SiteApp$() {
  $c_O.call(this)
}
$c_Lquizleague_web_site_SiteApp$.prototype = new $h_O();
$c_Lquizleague_web_site_SiteApp$.prototype.constructor = $c_Lquizleague_web_site_SiteApp$;
/** @constructor */
function $h_Lquizleague_web_site_SiteApp$() {
  /*<skip>*/
}
$h_Lquizleague_web_site_SiteApp$.prototype = $c_Lquizleague_web_site_SiteApp$.prototype;
$c_Lquizleague_web_site_SiteApp$.prototype.init___ = (function() {
  return this
});
$c_Lquizleague_web_site_SiteApp$.prototype.$$js$exported$meth$main__AT__O = (function(args) {
  this.main__AT__V(args)
});
$c_Lquizleague_web_site_SiteApp$.prototype.main__AT__V = (function(args) {
  $g.Vue.component("ql-app", {
    "data": (function($this) {
      return (function() {
        return {
          "drawer": true,
    ...
    "subscriptions": (function(this$2$1) {
      return (function() {
        return {
          "appData": $m_Lquizleague_web_site_SiteModule$().appData$1.inner$1
        }
      })
    })(this),
  ...
  var jsx$2 = $g.Vue;
  var jsx$1 = $m_Lcom_felstar_scalajs_vue_Router$();
  var this$5 = $m_Lquizleague_web_site_SiteModule$();
  new jsx$2({
    "el": "#app",
    "data": {},
    "methods": {},
    "computed": {},
    "filters": {},
    "router": jsx$1.apply__sjs_js_Array__T__T__T__T__Lcom_felstar_scalajs_vue_Router($f_Lquizleague_web_core_Module__apply__sjs_js_Array(this$5), "history", "/", null, null)
  })
});
$c_Lquizleague_web_site_SiteApp$.prototype.main = (function(arg$1) {
  var prep0 = $asArrayOf_T(arg$1, 1);
  return this.$$js$exported$meth$main__AT__O(prep0)
});
var $d_Lquizleague_web_site_SiteApp$ = new $TypeData().initClass({
  Lquizleague_web_site_SiteApp$: 0
}, false, "quizleague.web.site.SiteApp$", {
  Lquizleague_web_site_SiteApp$: 1,
  O: 1
});
$c_Lquizleague_web_site_SiteApp$.prototype.$classData = $d_Lquizleague_web_site_SiteApp$;
var $n_Lquizleague_web_site_SiteApp$ = (void 0);
function $m_Lquizleague_web_site_SiteApp$() {
  if ((!$n_Lquizleague_web_site_SiteApp$)) {
    $n_Lquizleague_web_site_SiteApp$ = new $c_Lquizleague_web_site_SiteApp$().init___()
  };
  return $n_Lquizleague_web_site_SiteApp$
}
/** @constructor */
...
/** @constructor */
function $c_Lrxscalajs_subjects_BehaviorSubject$() {
  $c_O.call(this)
}
$c_Lrxscalajs_subjects_BehaviorSubject$.prototype = new $h_O();
$c_Lrxscalajs_subjects_BehaviorSubject$.prototype.constructor = $c_Lrxscalajs_subjects_BehaviorSubject$;
/** @constructor */
function $h_Lrxscalajs_subjects_BehaviorSubject$() {
  /*<skip>*/
}
$h_Lrxscalajs_subjects_BehaviorSubject$.prototype = $c_Lrxscalajs_subjects_BehaviorSubject$.prototype;
$c_Lrxscalajs_subjects_BehaviorSubject$.prototype.init___ = (function() {
  return this
});
$c_Lrxscalajs_subjects_BehaviorSubject$.prototype.apply__O__Lrxscalajs_subjects_BehaviorSubject = (function(defaultValue) {
  return new $c_Lrxscalajs_subjects_BehaviorSubject().init___Lrxscalajs_facade_BehaviorSubjectFacade(new $g.Rx.BehaviorSubject(defaultValue))
});
var $d_Lrxscalajs_subjects_BehaviorSubject$ = new $TypeData().initClass({
  Lrxscalajs_subjects_BehaviorSubject$: 0
}, false, "rxscalajs.subjects.BehaviorSubject$", {
  Lrxscalajs_subjects_BehaviorSubject$: 1,
  O: 1
});
$c_Lrxscalajs_subjects_BehaviorSubject$.prototype.$classData = $d_Lrxscalajs_subjects_BehaviorSubject$;
var $n_Lrxscalajs_subjects_BehaviorSubject$ = (void 0);
function $m_Lrxscalajs_subjects_BehaviorSubject$() {
  if ((!$n_Lrxscalajs_subjects_BehaviorSubject$)) {
    $n_Lrxscalajs_subjects_BehaviorSubject$ = new $c_Lrxscalajs_subjects_BehaviorSubject$().init___()
  };
  return $n_Lrxscalajs_subjects_BehaviorSubject$
}
/** @constructor */
function $c_jl_Class() {
  $c_O.call(this);
...
/** @constructor */
function $c_Lquizleague_web_site_SiteModule$() {
  $c_O.call(this);
  this.modules$1 = null;
  this.routes$1 = null;
  this.appData$1 = null;
  this.config$1 = null;
  this.db$1 = null;
  this.appConfig$1 = null
}
$c_Lquizleague_web_site_SiteModule$.prototype = new $h_O();
$c_Lquizleague_web_site_SiteModule$.prototype.constructor = $c_Lquizleague_web_site_SiteModule$;
/** @constructor */
function $h_Lquizleague_web_site_SiteModule$() {
  /*<skip>*/
}
$h_Lquizleague_web_site_SiteModule$.prototype = $c_Lquizleague_web_site_SiteModule$.prototype;
$c_Lquizleague_web_site_SiteModule$.prototype.init___ = (function() {
  $n_Lquizleague_web_site_SiteModule$ = this;
  this.modules$1 = [$m_Lquizleague_web_site_home_HomeModule$(), $m_Lquizleague_web_site_team_TeamModule$()];
  var x$8 = $m_Lcom_felstar_scalajs_vue_RouteConfig$().apply$default$8__sjs_js_Array();
  this.routes$1 = [$m_Lcom_felstar_scalajs_vue_RouteConfig$().apply__T__sjs_js_Any__T__sci_Map__sjs_js_Any__sjs_js_Any__sjs_js_Any__sjs_js_Array__sjs_js_Object("", null, null, null, "/home", null, null, x$8)];
  this.appData$1 = $m_Lrxscalajs_subjects_BehaviorSubject$().apply__O__Lrxscalajs_subjects_BehaviorSubject(new $c_Lquizleague_web_site_AppData().init___T(""));
  this.config$1 = {
  ...
  var jsx$1 = $g.firebase;
  var a = this.config$1;
  jsx$1.initializeApp(a);
  this.db$1 = $g.firebase.firestore();
  this.appConfig$1 = this.db$1.doc("ApplicationConfig/LyIBn4rYvEbYjtBHW72x");
  this.appConfig$1.get().then((function(arg1$2) {
    return $m_Lquizleague_web_site_SiteModule$().quizleague$web$site$SiteModule$$$anonfun$new$1__sjs_js_Any__O(arg1$2)
  }), (function(arg1$2$1) {
    $as_jl_Error(arg1$2$1);
    $m_Lquizleague_web_site_SiteModule$();
    return ""
  }));
  return this
});
$c_Lquizleague_web_site_SiteModule$.prototype.components__sjs_js_Array = (function() {
  return $f_Lquizleague_web_core_Module__components__sjs_js_Array(this)
});
$c_Lquizleague_web_site_SiteModule$.prototype.modules__sjs_js_Array = (function() {
  return this.modules$1
});
$c_Lquizleague_web_site_SiteModule$.prototype.quizleague$web$site$SiteModule$$$anonfun$new$1__sjs_js_Any__O = (function(a) {
  var b = a.data();
  var x = new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["b as json : ", ""])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$as_T($g.JSON.stringify(b))]));
  var this$2 = $m_s_Console$();
  var this$3 = $as_Ljava_io_PrintStream(this$2.outVar$2.v$1);
  this$3.java$lang$JSConsoleBasedPrintStream$$printString__T__V((x + "\n"));
  this.appData$1.next__O__V(new $c_Lquizleague_web_site_AppData().init___T($objectToString(a.get("title"))))
});
$c_Lquizleague_web_site_SiteModule$.prototype.routes__sjs_js_Array = (function() {
  return this.routes$1
});
var $d_Lquizleague_web_site_SiteModule$ = new $TypeData().initClass({
  Lquizleague_web_site_SiteModule$: 0
}, false, "quizleague.web.site.SiteModule$", {
  Lquizleague_web_site_SiteModule$: 1,
  O: 1,
  Lquizleague_web_core_Module: 1
});
$c_Lquizleague_web_site_SiteModule$.prototype.$classData = $d_Lquizleague_web_site_SiteModule$;
var $n_Lquizleague_web_site_SiteModule$ = (void 0);
function $m_Lquizleague_web_site_SiteModule$() {
  if ((!$n_Lquizleague_web_site_SiteModule$)) {
    $n_Lquizleague_web_site_SiteModule$ = new $c_Lquizleague_web_site_SiteModule$().init___()
  };
  return $n_Lquizleague_web_site_SiteModule$
}
/** @constructor */
function $c_Lquizleague_web_site_home_HomeComponent$() {
  $c_O.call(this);
  this.component$1 = null
}
$c_Lquizleague_web_site_home_HomeComponent$.prototype = new $h_O();
$c_Lquizleague_web_site_home_HomeComponent$.prototype.constructor = $c_Lquizleague_web_site_home_HomeComponent$;
/** @constructor */
function $h_Lquizleague_web_site_home_HomeComponent$() {
  /*<skip>*/
}
$h_Lquizleague_web_site_home_HomeComponent$.prototype = $c_Lquizleague_web_site_home_HomeComponent$.prototype;
$c_Lquizleague_web_site_home_HomeComponent$.prototype.init___ = (function() {
  $n_Lquizleague_web_site_home_HomeComponent$ = this;
  var x$1 = (function($this) {
    return (function() {
      return {
        "appData": $m_Lquizleague_web_site_SiteModule$().appData$1.inner$1
      }
  ...
  this.component$1 = $m_Lcom_felstar_scalajs_vue_Component$().apply__T__sjs_js_Any__sjs_js_Any__sjs_js_Object("\n   <v-container grid-list-md >\n    <v-layout row>\n      <v-flex>\n        <v-carousel light dark>\n          <v-carousel-item src=\"\">\n            <ql-home-page-table></ql-home-page-table>\n          </v-carousel-item>\n          <v-carousel-item src=\"\">\n          </v-carousel-item>\n          <v-carousel-item src=\"\">Next Fixtures</v-carousel-item>\n        </v-carousel>\n      </v-flex>\n      <v-flex>\n        Some Text\n      </v-flex>\n    </v-layout>\n  </v-container>\n", null, x$1);
  return this
});
var $d_Lquizleague_web_site_home_HomeComponent$ = new $TypeData().initClass({
  Lquizleague_web_site_home_HomeComponent$: 0
}, false, "quizleague.web.site.home.HomeComponent$", {
  Lquizleague_web_site_home_HomeComponent$: 1,
  O: 1,
  Lquizleague_web_core_RouteComponent: 1
});
$c_Lquizleague_web_site_home_HomeComponent$.prototype.$classData = $d_Lquizleague_web_site_home_HomeComponent$;
var $n_Lquizleague_web_site_home_HomeComponent$ = (void 0);
function $m_Lquizleague_web_site_home_HomeComponent$() {
  if ((!$n_Lquizleague_web_site_home_HomeComponent$)) {
    $n_Lquizleague_web_site_home_HomeComponent$ = new $c_Lquizleague_web_site_home_HomeComponent$().init___()
  };
  return $n_Lquizleague_web_site_home_HomeComponent$
}
/** @constructor */
function $c_Lquizleague_web_site_home_HomeModule$() {
  $c_O.call(this);
  this.components$1 = null;
  this.routes$1 = null
}
$c_Lquizleague_web_site_home_HomeModule$.prototype = new $h_O();
$c_Lquizleague_web_site_home_HomeModule$.prototype.constructor = $c_Lquizleague_web_site_home_HomeModule$;
/** @constructor */
function $h_Lquizleague_web_site_home_HomeModule$() {
  /*<skip>*/
}
$h_Lquizleague_web_site_home_HomeModule$.prototype = $c_Lquizleague_web_site_home_HomeModule$.prototype;
$c_Lquizleague_web_site_home_HomeModule$.prototype.init___ = (function() {
  $n_Lquizleague_web_site_home_HomeModule$ = this;
  var array = [$m_Lquizleague_web_site_home_HomePageLeagueTable$()];
  this.components$1 = array;
  var this$6 = $m_Lquizleague_web_site_home_HomeComponent$();
  var y = this$6.component$1;
  var array$1 = [new $c_T2().init___O__O("default", y)];
  ...
  var x$2 = $as_sci_Map(this$9.elems$1);
  var x$8 = $m_Lcom_felstar_scalajs_vue_RouteConfig$().apply$default$8__sjs_js_Array();
  var array$2 = [$m_Lcom_felstar_scalajs_vue_RouteConfig$().apply__T__sjs_js_Any__T__sci_Map__sjs_js_Any__sjs_js_Any__sjs_js_Any__sjs_js_Array__sjs_js_Object("/home", null, null, x$2, null, null, null, x$8)];
  this.routes$1 = array$2;
  return this
});
$c_Lquizleague_web_site_home_HomeModule$.prototype.components__sjs_js_Array = (function() {
  return this.components$1
});
$c_Lquizleague_web_site_home_HomeModule$.prototype.modules__sjs_js_Array = (function() {
  return $f_Lquizleague_web_core_Module__modules__sjs_js_Array(this)
});
$c_Lquizleague_web_site_home_HomeModule$.prototype.routes__sjs_js_Array = (function() {
  return this.routes$1
});
var $d_Lquizleague_web_site_home_HomeModule$ = new $TypeData().initClass({
  Lquizleague_web_site_home_HomeModule$: 0
}, false, "quizleague.web.site.home.HomeModule$", {
  Lquizleague_web_site_home_HomeModule$: 1,
  O: 1,
  Lquizleague_web_core_Module: 1
});
$c_Lquizleague_web_site_home_HomeModule$.prototype.$classData = $d_Lquizleague_web_site_home_HomeModule$;
var $n_Lquizleague_web_site_home_HomeModule$ = (void 0);
function $m_Lquizleague_web_site_home_HomeModule$() {
  if ((!$n_Lquizleague_web_site_home_HomeModule$)) {
    $n_Lquizleague_web_site_home_HomeModule$ = new $c_Lquizleague_web_site_home_HomeModule$().init___()
  };
  return $n_Lquizleague_web_site_home_HomeModule$
}
/** @constructor */
function $c_Lquizleague_web_site_home_HomePageLeagueTable$() {
  $c_O.call(this)
}
$c_Lquizleague_web_site_home_HomePageLeagueTable$.prototype = new $h_O();
$c_Lquizleague_web_site_home_HomePageLeagueTable$.prototype.constructor = $c_Lquizleague_web_site_home_HomePageLeagueTable$;
/** @constructor */
function $h_Lquizleague_web_site_home_HomePageLeagueTable$() {
  /*<skip>*/
}
$h_Lquizleague_web_site_home_HomePageLeagueTable$.prototype = $c_Lquizleague_web_site_home_HomePageLeagueTable$.prototype;
$c_Lquizleague_web_site_home_HomePageLeagueTable$.prototype.init___ = (function() {
  return this
});
$c_Lquizleague_web_site_home_HomePageLeagueTable$.prototype.apply__sjs_js_Any = (function() {
  return $g.Vue.component("ql-home-page-table", {
    "template": "<v-card>\n              <v-card-title primary-title><h4>League Table</h4></v-card-title>\n              <v-card-text>League Table Text</v-card-text>\n            </v-card>"
  })
});
var $d_Lquizleague_web_site_home_HomePageLeagueTable$ = new $TypeData().initClass({
  Lquizleague_web_site_home_HomePageLeagueTable$: 0
}, false, "quizleague.web.site.home.HomePageLeagueTable$", {
  Lquizleague_web_site_home_HomePageLeagueTable$: 1,
  O: 1,
  Lquizleague_web_core_PageComponent: 1
});
$c_Lquizleague_web_site_home_HomePageLeagueTable$.prototype.$classData = $d_Lquizleague_web_site_home_HomePageLeagueTable$;
var $n_Lquizleague_web_site_home_HomePageLeagueTable$ = (void 0);
function $m_Lquizleague_web_site_home_HomePageLeagueTable$() {
  if ((!$n_Lquizleague_web_site_home_HomePageLeagueTable$)) {
    $n_Lquizleague_web_site_home_HomePageLeagueTable$ = new $c_Lquizleague_web_site_home_HomePageLeagueTable$().init___()
  };
  return $n_Lquizleague_web_site_home_HomePageLeagueTable$
}
/** @constructor */
function $c_Lquizleague_web_site_team_TeamModule$() {
  $c_O.call(this);
  this.routes$1 = null
}
$c_Lquizleague_web_site_team_TeamModule$.prototype = new $h_O();
$c_Lquizleague_web_site_team_TeamModule$.prototype.constructor = $c_Lquizleague_web_site_team_TeamModule$;
/** @constructor */
function $h_Lquizleague_web_site_team_TeamModule$() {
  /*<skip>*/
}
$h_Lquizleague_web_site_team_TeamModule$.prototype = $c_Lquizleague_web_site_team_TeamModule$.prototype;
$c_Lquizleague_web_site_team_TeamModule$.prototype.init___ = (function() {
  $n_Lquizleague_web_site_team_TeamModule$ = this;
  var this$2 = $m_Lquizleague_web_site_team_TeamsComponent$();
  var y = this$2.component$1;
  var jsx$1 = new $c_T2().init___O__O("default", y);
  var this$5 = $m_Lquizleague_web_site_team_TeamSidenavComponent$();
  var y$1 = this$5.component$1;
  var array = [jsx$1, new $c_T2().init___O__O("sidenav", y$1)];
  ...
  var x$2 = $as_sci_Map(this$8.elems$1);
  var x$8 = $m_Lcom_felstar_scalajs_vue_RouteConfig$().apply$default$8__sjs_js_Array();
  var array$1 = [$m_Lcom_felstar_scalajs_vue_RouteConfig$().apply__T__sjs_js_Any__T__sci_Map__sjs_js_Any__sjs_js_Any__sjs_js_Any__sjs_js_Array__sjs_js_Object("/team", null, null, x$2, null, null, null, x$8)];
  this.routes$1 = array$1;
  return this
});
$c_Lquizleague_web_site_team_TeamModule$.prototype.components__sjs_js_Array = (function() {
  return $f_Lquizleague_web_core_Module__components__sjs_js_Array(this)
});
$c_Lquizleague_web_site_team_TeamModule$.prototype.modules__sjs_js_Array = (function() {
  return $f_Lquizleague_web_core_Module__modules__sjs_js_Array(this)
});
$c_Lquizleague_web_site_team_TeamModule$.prototype.routes__sjs_js_Array = (function() {
  return this.routes$1
});
var $d_Lquizleague_web_site_team_TeamModule$ = new $TypeData().initClass({
  Lquizleague_web_site_team_TeamModule$: 0
}, false, "quizleague.web.site.team.TeamModule$", {
  Lquizleague_web_site_team_TeamModule$: 1,
  O: 1,
  Lquizleague_web_core_Module: 1
});
$c_Lquizleague_web_site_team_TeamModule$.prototype.$classData = $d_Lquizleague_web_site_team_TeamModule$;
var $n_Lquizleague_web_site_team_TeamModule$ = (void 0);
function $m_Lquizleague_web_site_team_TeamModule$() {
  if ((!$n_Lquizleague_web_site_team_TeamModule$)) {
    $n_Lquizleague_web_site_team_TeamModule$ = new $c_Lquizleague_web_site_team_TeamModule$().init___()
  };
  return $n_Lquizleague_web_site_team_TeamModule$
}
/** @constructor */
function $c_Lquizleague_web_site_team_TeamSidenavComponent$() {
  $c_O.call(this);
  this.component$1 = null
}
$c_Lquizleague_web_site_team_TeamSidenavComponent$.prototype = new $h_O();
$c_Lquizleague_web_site_team_TeamSidenavComponent$.prototype.constructor = $c_Lquizleague_web_site_team_TeamSidenavComponent$;
/** @constructor */
function $h_Lquizleague_web_site_team_TeamSidenavComponent$() {
  /*<skip>*/
}
$h_Lquizleague_web_site_team_TeamSidenavComponent$.prototype = $c_Lquizleague_web_site_team_TeamSidenavComponent$.prototype;
$c_Lquizleague_web_site_team_TeamSidenavComponent$.prototype.init___ = (function() {
  $n_Lquizleague_web_site_team_TeamSidenavComponent$ = this;
  this.component$1 = $m_Lcom_felstar_scalajs_vue_Component$().apply__T__sjs_js_Any__sjs_js_Any__sjs_js_Object("\n  <v-list dense>\n    <v-list-tile>Team 1</v-list-tile>\n    <v-list-tile>Team 2</v-list-tile>\n  </v-list>", null, null);
  return this
});
var $d_Lquizleague_web_site_team_TeamSidenavComponent$ = new $TypeData().initClass({
  Lquizleague_web_site_team_TeamSidenavComponent$: 0
}, false, "quizleague.web.site.team.TeamSidenavComponent$", {
  Lquizleague_web_site_team_TeamSidenavComponent$: 1,
  O: 1,
  Lquizleague_web_core_RouteComponent: 1
});
$c_Lquizleague_web_site_team_TeamSidenavComponent$.prototype.$classData = $d_Lquizleague_web_site_team_TeamSidenavComponent$;
var $n_Lquizleague_web_site_team_TeamSidenavComponent$ = (void 0);
function $m_Lquizleague_web_site_team_TeamSidenavComponent$() {
  if ((!$n_Lquizleague_web_site_team_TeamSidenavComponent$)) {
    $n_Lquizleague_web_site_team_TeamSidenavComponent$ = new $c_Lquizleague_web_site_team_TeamSidenavComponent$().init___()
  };
  return $n_Lquizleague_web_site_team_TeamSidenavComponent$
}
/** @constructor */
function $c_Lquizleague_web_site_team_TeamsComponent$() {
  $c_O.call(this);
  this.component$1 = null
}
$c_Lquizleague_web_site_team_TeamsComponent$.prototype = new $h_O();
$c_Lquizleague_web_site_team_TeamsComponent$.prototype.constructor = $c_Lquizleague_web_site_team_TeamsComponent$;
/** @constructor */
function $h_Lquizleague_web_site_team_TeamsComponent$() {
  /*<skip>*/
}
$h_Lquizleague_web_site_team_TeamsComponent$.prototype = $c_Lquizleague_web_site_team_TeamsComponent$.prototype;
$c_Lquizleague_web_site_team_TeamsComponent$.prototype.init___ = (function() {
  $n_Lquizleague_web_site_team_TeamsComponent$ = this;
  this.component$1 = $m_Lcom_felstar_scalajs_vue_Component$().apply__T__sjs_js_Any__sjs_js_Any__sjs_js_Object("<span>Teams</span>", null, null);
  return this
});
var $d_Lquizleague_web_site_team_TeamsComponent$ = new $TypeData().initClass({
  Lquizleague_web_site_team_TeamsComponent$: 0
}, false, "quizleague.web.site.team.TeamsComponent$", {
  Lquizleague_web_site_team_TeamsComponent$: 1,
  O: 1,
  Lquizleague_web_core_RouteComponent: 1
});
$c_Lquizleague_web_site_team_TeamsComponent$.prototype.$classData = $d_Lquizleague_web_site_team_TeamsComponent$;
var $n_Lquizleague_web_site_team_TeamsComponent$ = (void 0);
function $m_Lquizleague_web_site_team_TeamsComponent$() {
  if ((!$n_Lquizleague_web_site_team_TeamsComponent$)) {
    $n_Lquizleague_web_site_team_TeamsComponent$ = new $c_Lquizleague_web_site_team_TeamsComponent$().init___()
  };
  return $n_Lquizleague_web_site_team_TeamsComponent$
}
/** @constructor */
...
$c_Lrxscalajs_subjects_BehaviorSubject.prototype = new $h_Lrxscalajs_Subject();
$c_Lrxscalajs_subjects_BehaviorSubject.prototype.constructor = $c_Lrxscalajs_subjects_BehaviorSubject;
/** @constructor */
function $h_Lrxscalajs_subjects_BehaviorSubject() {
  /*<skip>*/
...
$h_Lrxscalajs_subjects_BehaviorSubject.prototype = $c_Lrxscalajs_subjects_BehaviorSubject.prototype;
$c_Lrxscalajs_subjects_BehaviorSubject.prototype.init___Lrxscalajs_facade_BehaviorSubjectFacade = (function(inner) {
...
/** @constructor */
function $c_Lquizleague_web_site_AppData() {
  $c_O.call(this);
  this.title$1 = null
}
$c_Lquizleague_web_site_AppData.prototype = new $h_O();
$c_Lquizleague_web_site_AppData.prototype.constructor = $c_Lquizleague_web_site_AppData;
/** @constructor */
function $h_Lquizleague_web_site_AppData() {
  /*<skip>*/
}
$h_Lquizleague_web_site_AppData.prototype = $c_Lquizleague_web_site_AppData.prototype;
$c_Lquizleague_web_site_AppData.prototype.productPrefix__T = (function() {
  return "AppData"
});
$c_Lquizleague_web_site_AppData.prototype.productArity__I = (function() {
  return 1
});
$c_Lquizleague_web_site_AppData.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lquizleague_web_site_AppData(x$1)) {
    var AppData$1 = $as_Lquizleague_web_site_AppData(x$1);
    return (this.title$1 === AppData$1.title$1)
  } else {
    return false
  }
});
$c_Lquizleague_web_site_AppData.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.title$1;
      break
...
$c_Lquizleague_web_site_AppData.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lquizleague_web_site_AppData.prototype.init___T = (function(title) {
  this.title$1 = title;
  return this
});
$c_Lquizleague_web_site_AppData.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lquizleague_web_site_AppData.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
$c_Lquizleague_web_site_AppData.prototype.$$js$exported$prop$title__O = (function() {
  return this.title$1
});
Object.defineProperty($c_Lquizleague_web_site_AppData.prototype, "title", {
  "get": (function() {
    return this.$$js$exported$prop$title__O()
  }),
  "configurable": true
});
function $is_Lquizleague_web_site_AppData(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lquizleague_web_site_AppData)))
}
function $as_Lquizleague_web_site_AppData(obj) {
  return (($is_Lquizleague_web_site_AppData(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "quizleague.web.site.AppData"))
}
function $isArrayOf_Lquizleague_web_site_AppData(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lquizleague_web_site_AppData)))
}
function $asArrayOf_Lquizleague_web_site_AppData(obj, depth) {
  return (($isArrayOf_Lquizleague_web_site_AppData(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lquizleague.web.site.AppData;", depth))
}
var $d_Lquizleague_web_site_AppData = new $TypeData().initClass({
  Lquizleague_web_site_AppData: 0
}, false, "quizleague.web.site.AppData", {
  Lquizleague_web_site_AppData: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Lquizleague_web_site_AppData.prototype.$classData = $d_Lquizleague_web_site_AppData;
/** @constructor */
...
$m_Lquizleague_web_site_SiteApp$().main__AT__V($makeNativeArrayWrapper($d_T.getArrayOf(), []));
}).call(this);
//# sourceMappingURL=scala-js-vue-js-example-fastopt.js.map
